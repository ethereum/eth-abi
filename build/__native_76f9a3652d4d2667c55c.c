...
char CPyDef__codec_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[228]; /* ('TYPE_CHECKING', 'Any', 'Iterable', 'Tuple') */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[229]; /* ('Decodable', 'TypeStr') */
    ...
    cpy_r_r13 = CPyStatics[230]; /* ('validate_bytes_param', 'validate_list_like_param') */
...
PyObject *CPyDef__decoding_____set_uint256_decoder(void) {
    ...
    PyObject *cpy_r_r15;
    PyObject *cpy_r_r16;
    cpy_r_r0 = CPyStatics[231]; /* ('decoding',) */
    ...
    if (unlikely(cpy_r_r6 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "__set_uint256_decoder", 37, CPyStatic__decoding___globals);
        goto CPyL6;
    }
    ...
    if (unlikely(cpy_r_r15 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "__set_uint256_decoder", 39, CPyStatic__decoding___globals);
        goto CPyL6;
    }
    return cpy_r_r15;
CPyL6: ;
...
CPyTagged CPyDef__decoding___decode_uint_256(PyObject *cpy_r_stream) {
    ...
    if (unlikely(cpy_r_r2 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 43, CPyStatic__decoding___globals);
        goto CPyL7;
    }
...
CPyL2: ;
    ...
    if (unlikely(cpy_r_r5 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 45, CPyStatic__decoding___globals);
        goto CPyL7;
    }
...
CPyL4: ;
    ...
    if (unlikely(cpy_r_r8 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 46, CPyStatic__decoding___globals);
        goto CPyL7;
    }
...
PyObject *CPyPy__decoding___decode_uint_256(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 42, CPyStatic__decoding___globals);
    return NULL;
}
...
CPyL8: ;
    ...
    if (unlikely(cpy_r_r23 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_head_tail", 64, CPyStatic__decoding___globals);
        goto CPyL15;
    } else
        goto CPyL16;
CPyL10: ;
...
PyObject *CPyDef__decoding___decode_tuple(PyObject *cpy_r_self, PyObject *cpy_r_stream) {
    ...
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_tuple", 71, CPyStatic__decoding___globals);
        goto CPyL10;
    } else
        goto CPyL11;
CPyL1: ;
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r18 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_sized_array", 84, CPyStatic__decoding___globals);
        goto CPyL23;
    } else
        goto CPyL24;
CPyL9: ;
...
PyObject *CPyDef__decoding___read_fixed_byte_size_data_from_stream(PyObject *cpy_r_self, PyObject *cpy_r_stream) {
    ...
    if (likely(PyBytes_Check(cpy_r_r7) || PyByteArray_Check(cpy_r_r7)))
        ...
        CPy_TypeErrorTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 113, CPyStatic__decoding___globals, "bytes", cpy_r_r7);
        goto CPyL15;
    }
    CPy_INCREF(cpy_r_r8);
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r14 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 116, CPyStatic__decoding___globals);
        goto CPyL17;
    }
    ...
    cpy_r_r23 = CPyStatics[43]; /* 'InsufficientDataBytes' */
...
PyObject *CPyPy__decoding___read_fixed_byte_size_data_from_stream(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 106, CPyStatic__decoding___globals);
    return NULL;
}
...
char CPyDef__decoding_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[232]; /* ('TYPE_CHECKING', 'Any', 'Optional', 'Tuple') */
    cpy_r_r6 = CPyStatics[16]; /* 'typing' */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[233]; /* ('InsufficientDataBytes',) */
    cpy_r_r10 = CPyStatics[45]; /* 'faster_eth_abi.exceptions' */
    ...
    CPyModule_faster_eth_abi___exceptions = cpy_r_r12;
    CPy_INCREF(CPyModule_faster_eth_abi___exceptions);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[234]; /* ('BytesIO', 'ContextFramesBytesIO') */
    cpy_r_r14 = CPyStatics[48]; /* 'faster_eth_abi.io' */
    ...
    CPyModule_faster_eth_abi___io = cpy_r_r16;
    CPy_INCREF(CPyModule_faster_eth_abi___io);
    CPy_DECREF(cpy_r_r16);
    cpy_r_r17 = CPyStatic__decoding___globals;
    cpy_r_r18 = CPyStatics[27]; /* '_UINT256_DECODER' */
    cpy_r_r19 = Py_None;
    cpy_r_r20 = CPyDict_SetItem(cpy_r_r17, cpy_r_r18, cpy_r_r19);
    cpy_r_r21 = cpy_r_r20 >= 0;
    if (unlikely(!cpy_r_r21)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "<module>", 27, CPyStatic__decoding___globals);
        goto CPyL9;
    }
    return 1;
CPyL9: ;
...
CPyL4: ;
    ...
    cpy_r_r6 = CPyStatics[49]; /* 'is_dynamic' */
...
CPyL36: ;
    ...
    cpy_r_r74 = CPyStatics[50]; /* 'accumulate' */
...
PyObject *CPyDef__encoding___encode_fixed(PyObject *cpy_r_value, PyObject *cpy_r_encode_fn, char cpy_r_is_big_endian, CPyTagged cpy_r_data_byte_size) {
    ...
    cpy_r_r4 = CPyStatics[214]; /* b'\x00' */
    cpy_r_r5 = CPyStatics[51]; /* 'rjust' */
    ...
    return cpy_r_r10;
CPyL6: ;
    cpy_r_r11 = CPyStatics[214]; /* b'\x00' */
    cpy_r_r12 = CPyStatics[52]; /* 'ljust' */
    CPyTagged_INCREF(cpy_r_data_byte_size);
...
PyObject *CPyDef__encoding___encode_signed(PyObject *cpy_r_value, PyObject *cpy_r_encode_fn, CPyTagged cpy_r_data_byte_size) {
    ...
    cpy_r_r7 = CPyStatics[214]; /* b'\x00' */
    cpy_r_r8 = CPyStatics[51]; /* 'rjust' */
    CPyTagged_INCREF(cpy_r_data_byte_size);
    ...
    return cpy_r_r13;
CPyL8: ;
    cpy_r_r14 = CPyStatics[215]; /* b'\xff' */
    cpy_r_r15 = CPyStatics[51]; /* 'rjust' */
    CPyTagged_INCREF(cpy_r_data_byte_size);
...
CPyL6: ;
    ...
    cpy_r_r11 = CPyStatics[49]; /* 'is_dynamic' */
...
CPyL24: ;
    ...
    cpy_r_r39 = CPyStatics[50]; /* 'accumulate' */
...
PyObject *CPyDef__encoding___encode_uint_256(CPyTagged cpy_r_i) {
    ...
    cpy_r_r1 = CPyStatics[214]; /* b'\x00' */
    cpy_r_r2 = CPyStatics[51]; /* 'rjust' */
    cpy_r_r3 = CPyStatics[216]; /* 32 */
...
PyObject *CPyDef__encoding___int_to_big_endian(CPyTagged cpy_r_value) {
    ...
    PyObject *cpy_r_r17;
    PyObject *cpy_r_r18;
    cpy_r_r0 = CPyStatics[53]; /* 'bit_length' */
...
CPyL5: ;
    cpy_r_r9 = 2;
CPyL6: ;
    cpy_r_r10 = CPyStatics[54]; /* 'big' */
    cpy_r_r11 = CPyStatics[55]; /* 'to_bytes' */
    CPyTagged_INCREF(cpy_r_value);
...
char CPyDef__encoding_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[235]; /* ('accumulate',) */
    cpy_r_r6 = CPyStatics[56]; /* 'itertools' */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[236]; /* ('TYPE_CHECKING', 'Any', 'Callable', 'List', 'Optional',
                                   'Sequence', 'TypeVar') */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[61]; /* 'T' */
    cpy_r_r14 = CPyStatic__encoding___globals;
    cpy_r_r15 = CPyStatics[60]; /* 'TypeVar' */
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[238]; /* ('ABICodec',) */
    cpy_r_r10 = CPyStatics[64]; /* 'faster_eth_abi.codec' */
    ...
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[239]; /* ('registry',) */
    cpy_r_r14 = CPyStatics[66]; /* 'faster_eth_abi.registry' */
    ...
    cpy_r_r18 = CPyStatics[65]; /* 'registry' */
    ...
    cpy_r_r21 = CPyStatics[63]; /* 'ABICodec' */
    ...
    cpy_r_r27 = CPyStatics[67]; /* 'default_codec' */
    ...
    CPy_Unreachable();
CPyL13: ;
    cpy_r_r32 = CPyStatics[68]; /* 'encode' */
    ...
    cpy_r_r35 = CPyStatics[68]; /* 'encode' */
    ...
    CPy_Unreachable();
CPyL18: ;
    cpy_r_r40 = CPyStatics[69]; /* 'decode' */
    ...
    cpy_r_r43 = CPyStatics[69]; /* 'decode' */
    ...
    CPy_Unreachable();
CPyL23: ;
    cpy_r_r48 = CPyStatics[70]; /* 'is_encodable' */
    ...
    cpy_r_r51 = CPyStatics[70]; /* 'is_encodable' */
    ...
    CPy_Unreachable();
CPyL28: ;
    cpy_r_r56 = CPyStatics[71]; /* 'is_encodable_type' */
    ...
    cpy_r_r59 = CPyStatics[71]; /* 'is_encodable_type' */
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = (CPyTagged)CPyStatics[218] | 1; /* 115792089237316195423570985008687907853269984665640564039457584007913129639936 */
    cpy_r_r10 = CPyStatic_constants___globals;
    cpy_r_r11 = CPyStatics[72]; /* 'TT256' */
    ...
    cpy_r_r15 = (CPyTagged)CPyStatics[219] | 1; /* 115792089237316195423570985008687907853269984665640564039457584007913129639935 */
    cpy_r_r16 = CPyStatic_constants___globals;
    cpy_r_r17 = CPyStatics[73]; /* 'TT256M1' */
    ...
    cpy_r_r21 = (CPyTagged)CPyStatics[220] | 1; /* 57896044618658097711785492504343953926634992332820282019728792003956564819968 */
    cpy_r_r22 = CPyStatic_constants___globals;
    cpy_r_r23 = CPyStatics[74]; /* 'TT255' */
...
CPyL2: ;
    ...
    cpy_r_r3 = CPyStatics[75]; /* 'normalize' */
    ...
    cpy_r_r18 = CPyStatics[77]; /* '' */
    cpy_r_r19 = CPyStatics[78]; /* '{:{}}' */
    cpy_r_r20 = CPyStatics[77]; /* '' */
    cpy_r_r21 = CPyStatics[79]; /* 'format' */
    ...
    cpy_r_r26 = CPyStatics[80]; /* ' (normalized to ' */
    cpy_r_r27 = CPyStatics[81]; /* '{!r:{}}' */
    cpy_r_r28 = CPyStatics[77]; /* '' */
    cpy_r_r29 = CPyStatics[79]; /* 'format' */
...
CPyL1: ;
    ...
    cpy_r_r2 = CPyStatics[75]; /* 'normalize' */
...
CPyL9: ;
    ...
    cpy_r_r24 = CPyStatics[80]; /* ' (normalized to ' */
...
CPyL3: ;
    ...
    cpy_r_r10 = CPyStatics[241]; /* (('functools', 'functools', 'functools'),) */
    ...
    cpy_r_r15 = CPyStatics[242]; /* ('TYPE_CHECKING', 'Any', 'Callable', 'Optional', 'Type',
                                    'TypeVar') */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r18);
    cpy_r_r19 = CPyStatics[243]; /* ('TypeStr',) */
    ...
    CPy_INCREF(CPyModule_eth_typing);
    CPy_DECREF(cpy_r_r22);
    cpy_r_r23 = CPyStatics[244]; /* ('ABIType', 'BasicType', 'TupleType', 'normalize',
                                    'parse') */
    ...
    cpy_r_r34 = CPyStatics[60]; /* 'TypeVar' */
    ...
    cpy_r_r38 = CPyStatics[245]; /* ('bound',) */
    ...
    cpy_r_r45 = CPyStatics[57]; /* 'Callable' */
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[246]; /* ('ABIEncoder',) */
    cpy_r_r10 = CPyStatics[64]; /* 'faster_eth_abi.codec' */
    ...
    CPy_INCREF(CPyModule_faster_eth_abi___codec);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[247]; /* ('registry_packed',) */
    cpy_r_r14 = CPyStatics[66]; /* 'faster_eth_abi.registry' */
...
CPyL13: ;
    ...
    CPy_Unreachable();
CPyL18: ;
    cpy_r_r40 = CPyStatics[70]; /* 'is_encodable' */
    cpy_r_r41 = CPyObject_GetAttr(cpy_r_r38, cpy_r_r40);
    if (unlikely(cpy_r_r41 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/packed.py", "<module>", 15, CPyStatic_packed___globals);
        goto CPyL21;
...
char CPyDef_tools_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[248]; /* ('get_abi_strategy',) */
...
CPyL7: ;
    ...
    cpy_r_r14 = CPyStatics[75]; /* 'normalize' */
    cpy_r_r15 = CPyDict_GetItem(cpy_r_r13, cpy_r_r14);
    if (unlikely(cpy_r_r15 == NULL)) {
...
PyObject *CPyDef__strategies___get_uint_strategy(PyObject *cpy_r_abi_type, PyObject *cpy_r_registry) {
    ...
    cpy_r_r10 = CPyStatics[217]; /* 0 */
    PyObject *cpy_r_r11[3] = {cpy_r_r4, cpy_r_r10, cpy_r_r8};
    cpy_r_r12 = (PyObject **)&cpy_r_r11;
    cpy_r_r13 = CPyStatics[250]; /* ('min_value', 'max_value') */
...
PyObject *CPyDef__strategies___get_int_strategy(PyObject *cpy_r_abi_type, PyObject *cpy_r_registry) {
    ...
    cpy_r_r18 = (PyObject **)&cpy_r_r17;
    cpy_r_r19 = CPyStatics[250]; /* ('min_value', 'max_value') */
...
CPyL11: ;
    ...
    cpy_r_r17 = CPyStatics[217]; /* 0 */
    cpy_r_r18 = CPyStatics[217]; /* 0 */
    PyObject *cpy_r_r19[4] = {cpy_r_r11, cpy_r_r17, cpy_r_r15, cpy_r_r18};
    cpy_r_r20 = (PyObject **)&cpy_r_r19;
    cpy_r_r21 = CPyStatics[251]; /* ('min_value', 'max_value', 'places') */
...
CPyL11: ;
    ...
    cpy_r_r24 = CPyStatics[217]; /* 0 */
    PyObject *cpy_r_r25[4] = {cpy_r_r11, cpy_r_r16, cpy_r_r22, cpy_r_r24};
    cpy_r_r26 = (PyObject **)&cpy_r_r25;
    cpy_r_r27 = CPyStatics[251]; /* ('min_value', 'max_value', 'places') */
...
PyObject *CPyDef__strategies___get_bytes_strategy(PyObject *cpy_r_abi_type, PyObject *cpy_r_registry) {
    ...
    cpy_r_r7 = (PyObject **)&cpy_r_r6;
    cpy_r_r8 = CPyStatics[252]; /* ('min_size', 'max_size') */
...
CPyL11: ;
    ...
    cpy_r_r29 = CPyStatics[252]; /* ('min_size', 'max_size') */
...
char CPyDef__strategies_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[253]; /* ('Callable', 'Final', 'Optional', 'Union') */
    cpy_r_r6 = CPyStatics[16]; /* 'typing' */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[254]; /* ('to_checksum_address',) */
    ...
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[243]; /* ('TypeStr',) */
    ...
    CPy_DECREF(cpy_r_r16);
    cpy_r_r17 = CPyStatics[255]; /* ('strategies',) */
    cpy_r_r18 = CPyStatics[256]; /* ('st',) */
    ...
    CPy_DECREF(cpy_r_r21);
    cpy_r_r22 = CPyStatics[244]; /* ('ABIType', 'BasicType', 'TupleType', 'normalize',
                                    'parse') */
    ...
    CPy_INCREF(CPyModule_faster_eth_abi___grammar);
    CPy_DECREF(cpy_r_r25);
    cpy_r_r26 = CPyStatics[257]; /* ('BaseEquals', 'BaseRegistry', 'Lookup',
                                    'PredicateMapping', 'has_arrlist', 'is_base_tuple') */
    cpy_r_r27 = CPyStatics[66]; /* 'faster_eth_abi.registry' */
    ...
    cpy_r_r30 = CPyStatics[258]; /* ('scale_places',) */
    ...
    cpy_r_r35 = CPyStatics[57]; /* 'Callable' */
    ...
    *(PyObject * *)cpy_r_r44 = cpy_r_r40;
    ...
    cpy_r_r97 = CPyStatics[224]; /* 20 */
    cpy_r_r98 = CPyStatics[224]; /* 20 */
    PyObject *cpy_r_r99[3] = {cpy_r_r95, cpy_r_r97, cpy_r_r98};
    cpy_r_r100 = (PyObject **)&cpy_r_r99;
    cpy_r_r101 = CPyStatics[252]; /* ('min_size', 'max_size') */
    ...
    cpy_r_r129 = CPyStatics[217]; /* 0 */
    cpy_r_r130 = CPyStatics[225]; /* 4096 */
    PyObject *cpy_r_r131[3] = {cpy_r_r127, cpy_r_r129, cpy_r_r130};
    cpy_r_r132 = (PyObject **)&cpy_r_r131;
    cpy_r_r133 = CPyStatics[252]; /* ('min_size', 'max_size') */
...
CPyL63: ;
    ...
    cpy_r_r192 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL72: ;
    ...
    cpy_r_r207 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL95: ;
    ...
    cpy_r_r250 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL102: ;
    ...
    cpy_r_r266 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL111: ;
    ...
    cpy_r_r281 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL118: ;
    ...
    cpy_r_r297 = CPyStatics[259]; /* ('with_sub',) */
...
CPyL4: ;
    ...
    cpy_r_r6 = CPyStatics[186]; /* 'localcontext' */
    cpy_r_r7 = CPyObject_GetAttr(cpy_r_r5, cpy_r_r6);
    if (unlikely(cpy_r_r7 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/utils/numeric.py", "compute_unsigned_fixed_bounds", 42, CPyStatic_numeric___globals);
        goto CPyL50;
    ...
    cpy_r_r12 = CPyStatics[187]; /* '__exit__' */
    cpy_r_r13 = CPyObject_GetAttr(cpy_r_r11, cpy_r_r12);
    if (unlikely(cpy_r_r13 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/utils/numeric.py", "compute_unsigned_fixed_bounds", 42, CPyStatic_numeric___globals);
        goto CPyL51;
    }
    cpy_r_r14 = CPyStatics[188]; /* '__enter__' */
...
CPyL4: ;
    ...
    cpy_r_r10 = CPyStatics[186]; /* 'localcontext' */
    ...
    cpy_r_r16 = CPyStatics[187]; /* '__exit__' */
    cpy_r_r17 = CPyObject_GetAttr(cpy_r_r15, cpy_r_r16);
    if (unlikely(cpy_r_r17 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/utils/numeric.py", "compute_signed_fixed_bounds", 54, CPyStatic_numeric___globals);
        goto CPyL56;
    }
    cpy_r_r18 = CPyStatics[188]; /* '__enter__' */
...
CPyL4: ;
    ...
    cpy_r_r4 = CPyStatics[186]; /* 'localcontext' */
    ...
    cpy_r_r10 = CPyStatics[187]; /* '__exit__' */
    cpy_r_r11 = CPyObject_GetAttr(cpy_r_r9, cpy_r_r10);
    if (unlikely(cpy_r_r11 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/utils/numeric.py", "f", 77, CPyStatic_numeric___globals);
        goto CPyL40;
    }
    cpy_r_r12 = CPyStatics[188]; /* '__enter__' */
...
CPyL2: ;
    ...
    cpy_r_r13 = CPyStatics[78]; /* '{:{}}' */
    CPyTagged_INCREF(cpy_r_places);
    cpy_r_r14 = CPyTagged_StealAsObject(cpy_r_places);
    cpy_r_r15 = CPy_TYPE(cpy_r_r14);
    CPy_DECREF(cpy_r_r14);
    cpy_r_r16 = CPyStatics[77]; /* '' */
    cpy_r_r17 = CPyStatics[79]; /* 'format' */
...
CPyL13: ;
    ...
    cpy_r_r39 = CPyStatics[186]; /* 'localcontext' */
    ...
    cpy_r_r45 = CPyStatics[187]; /* '__exit__' */
    cpy_r_r46 = CPyObject_GetAttr(cpy_r_r44, cpy_r_r45);
    if (unlikely(cpy_r_r46 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/utils/numeric.py", "scale_places", 73, CPyStatic_numeric___globals);
        goto CPyL68;
    }
    cpy_r_r47 = CPyStatics[188]; /* '__enter__' */
...
CPyL56: ;
    ...
    cpy_r_r95 = CPyStatics[194]; /* 'scale_by_' */
    ...
    cpy_r_r97 = CPyStatics[195]; /* '__name__' */
    ...
    cpy_r_r100 = CPyStatics[196]; /* '__qualname__' */
...
CPyL3: ;
    ...
    cpy_r_r27 = CPyStatics[226]; /* 999 */
    PyObject *cpy_r_r28[1] = {cpy_r_r27};
    cpy_r_r29 = (PyObject **)&cpy_r_r28;
    cpy_r_r30 = CPyStatics[263]; /* ('prec',) */
    ...
    cpy_r_r37 = CPyStatics[203]; /* 'Decimal' */
    ...
    cpy_r_r59 = CPyStatics[203]; /* 'Decimal' */
    ...
    cpy_r_r62 = CPyStatics[203]; /* 'Decimal' */
...
PyObject *CPyDef_padding___zpad(PyObject *cpy_r_value, CPyTagged cpy_r_length) {
    ...
    PyObject *cpy_r_r6;
    PyObject *cpy_r_r7;
    cpy_r_r0 = CPyStatics[214]; /* b'\x00' */
    cpy_r_r1 = CPyStatics[51]; /* 'rjust' */
...
CPyL11: ;
    ...
    if (cpy_r_r15) {
        ...
        goto CPyL16;
CPyL12: ;
    cpy_r_r16 = CPyStatics[206]; /* 'Abbreviation limit may not be less than 3' */
...
char CPyDef_validation___validate_bytes_param(PyObject *cpy_r_param, PyObject *cpy_r_param_name) {
    ...
    cpy_r_r2 = CPyStatics[208]; /* 'bytearray' */
    ...
    cpy_r_r9 = CPyStatics[209]; /* 'The `' */
    cpy_r_r10 = CPyStatics[210]; /* '` value must be of bytes type. Got ' */
    ...
    cpy_r_r15 = CPyStatics[211]; /* 'TypeError' */
...
char CPyDef_validation___validate_list_like_param(PyObject *cpy_r_param, PyObject *cpy_r_param_name) {
    ...
    cpy_r_r6 = cpy_r_r4;
    if (cpy_r_r6) goto CPyL8;
    cpy_r_r7 = CPyStatics[209]; /* 'The `' */
    cpy_r_r8 = CPyStatics[212]; /* '` value type must be one of list or tuple. Got ' */
    ...
    cpy_r_r13 = CPyStatics[211]; /* 'TypeError' */
...
const char * const CPyLit_Str[] = {
    ...
    "\005\026`item_decoder` is None\narray_size\016data_byte_size\004read\016Tried to read ",
    "\004\021 bytes, only got \a bytes.\025InsufficientDataBytes\bOptional",
...
const int CPyLit_Tuple[] = {
    37, 4, 12, 13, 14, 15, 2, 17, 18, 2, 20, 21, 1, 23, 4, 12, 13, 44,
    15, 1, 43, 2, 46, 47, 1, 50, 7, 12, 13, 57, 58, 44, 59, 60, 1, 62, 1,
    63, 1, 65, 3, 100, 100, 100, 1, 240, 6, 12, 13, 57, 44, 103, 60, 1,
    18, 5, 104, 83, 98, 75, 76, 1, 108, 1, 111, 1, 112, 1, 116, 1, 121, 2,
    128, 129, 3, 128, 129, 131, 2, 134, 135, 4, 57, 62, 44, 141, 1, 142,
    1, 145, 1, 124, 6, 147, 148, 149, 119, 150, 151, 1, 152, 1, 172, 3,
    197, 197, 197, 1, 260, 3, 57, 62, 15, 1, 201, 1, 13
};
