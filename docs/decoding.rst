...
The :any:`decode` function provides an API for decoding ABI types. It accepts a list of type strings as the first
argumentand and the binary data to be decoded for the second argument as a python ``bytes`` or ``bytearray`` value.
